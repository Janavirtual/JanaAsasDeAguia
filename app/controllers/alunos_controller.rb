class AlunosController < ApplicationController
  ...
  def destroy
    @aluno.destroy
    respond_to do |format|
      format.html { redirect_to alunos_url, notice: 'Aluno Salvo com sucesso!' }
  ...
  private
    ...
    def aluno_params
      params.require(:aluno).permit(:nome, :sobrenome, :cpf, :endereco, :profissao, :email, :cnh, :escolaridade, :instituicao, :curso)
    end
end
